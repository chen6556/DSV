...
bool is_intersected(const Point &point0, const Point &point1, const Point &point2, const Point &point3, Point &output,
                    const bool infinite = false);

// 判断线段是否与圆相交并尝试获取交点,返回交点数量
int is_intersected(const Point &point0, const Point &point1, const Circle &circle, Point &output0, Point &output1,
                   const bool infinite = false);

// 判断线段是否与椭圆相交并尝试获取交点,返回交点数量
int is_intersected(const Point &point0, const Point &point1, const Ellipse &ellipse, Point &output0, Point &output1,
                   const bool infinite = false);
...
int is_intersected(const Arc &arc, const BSpline &bspline, const bool is_cubic, std::vector<Point> &intersections,
                   std::vector<std::tuple<double, double, double>> *tvalues = nullptr);
...
int is_intersected(const BSpline &bspline0, const bool is_cubic0, const BSpline &bspline1, const bool is_cubic1,
                   std::vector<Point> &intersections, std::vector<std::tuple<double, double, double>> *tvalues0 = nullptr,
...
bool find_intersections(const Polyline &polyline0, const Polyline &polyline1, const Point &pos, const double distance,
...
bool find_intersections(const Polyline &polyline, const BSpline &bspline, const bool is_cubic, const Point &pos, const double distance,
                        std::vector<Point> &intersections);

// 找到Polyline与Cirlce在pos附近的交点
bool find_intersections(const Polyline &polyline, const Circle &circle, const Point &pos, const double distance,
                        std::vector<Point> &intersections);

// 找到Polyline与Ellipse在pos附近的交点
bool find_intersections(const Polyline &polyline, const Ellipse &ellipse, const Point &pos, const double distance,
                        std::vector<Point> &intersections);

// 找到Polyline与Arc在pos附件的交点
bool find_intersections(const Polyline &polyline, const Arc &arc, const Point &pos, const double distance,
                        std::vector<Point> &intersections);

// 找到Circle与Circle在pos附近的交点
bool find_intersections(const Circle &circle0, const Circle &circle1, const Point &pos, const double distance,
                        std::vector<Point> &intersections);

// 找到Ellipse与Ellipse在pos附近的交点
bool find_intersections(const Ellipse &ellipse0, const Ellipse &ellipse1, const Point &pos, const double distance,
                        std::vector<Point> &intersections);

// 找到Ellipse与Circle在pos附近的交点
bool find_intersections(const Ellipse &ellipse, const Circle &circle, const Point &pos, const double distance,
                        std::vector<Point> &intersections);
